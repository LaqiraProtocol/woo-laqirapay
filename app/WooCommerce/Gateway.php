...
class Gateway extends WC_Payment_Gateway
{
    ...
    public function __construct(?PaymentController $controller = null)
    {
        ...
        add_filter( 'woocommerce_form_field', [ $this, 'laqirapay_checkout_fields_in_label_error' ], 10, 4 );
        add_action( 'woocommerce_review_order_before_submit', [ $this, 'laqira_validation_checkout' ] );
        add_action( 'wp_enqueue_scripts', [ $this, 'enqueue_validation_assets' ] );
    }
