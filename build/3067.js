"use strict";(self.webpackChunklaqira_payments=self.webpackChunklaqira_payments||[]).push([[3067],{3067(e,t,i){i.r(t),i.d(t,{AppKitModal:()=>ge,W3mModal:()=>ve,W3mModalBase:()=>he});var o=i(2618),a=i(2745),r=i(31),s=i(4376),n=i(2733),c=i(4833),l=i(6056),w=i(6010),d=i(8249),p=i(8508),u=i(346);const m={isUnsupportedChainView:()=>"UnsupportedChain"===p.I.state.view||"SwitchNetwork"===p.I.state.view&&p.I.state.history.includes("UnsupportedChain"),async safeClose(){this.isUnsupportedChainView()||await u.U.isSIWXCloseDisabled()?c.W.shake():c.W.close()}};var h=i(8996),v=i(1871),g=i(6742),y=i(2855),f=i(6109),b=i(3494);const k=o.AH`
  :host {
    display: block;
